...
export default function Sidebar({ userRoles, isOpen = false, onClose }: Props) {
  return (
    <aside className={`${isOpen ? 'block' : 'hidden'} h-full p-4 md:block`}>
      <button type="button" className="mb-4 md:hidden" onClick={onClose}>
        Close
      </button>
      <div className="mb-6">
